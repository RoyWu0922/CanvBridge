const I18N = {
  zh: {
    ...
    "settings.ignore_hint": "忽略的课不再出现在顶部课程区、也不参与筛选。先点「加载课程」再来设置。",
    "settings.ignore_empty": "还没有课程，先关闭设置并点击「加载课程」。",
  ...
  en: {
    ...
    "settings.group.ignore": "Ignored courses",
    "settings.language": "Language",
    "settings.ignore_heading": "Ignored courses",
    "settings.ignore_hint": "Ignored courses are hidden from the course area and never auto-selected. Load courses first.",
    "settings.ignore_empty": "No courses yet. Close settings and click “Load courses”.",
